...
(function($) {
    $.fn.formset = function(opts) {
            ...
            insertDeleteLink = function(row) {
                ...
                row.find('a.' + options.deleteCssClass).click(function() {
                    ...
                    if (del.length) {
                        ...
                        del.val('on');
                        row.fadeOut(options.removeAnimationDuration, function() {
        ...
        if ($$.length) {
            ...
            addButton.click(function() {
                ...
                row.insertBefore($(buttonRow)).fadeIn(options.addAnimationDuration, function() {
    ...
    $.fn.formset.defaults = {
        ...
        addAnimationDuration: 0, // Duration of animating the addition of a form
        removed: null, // Function called each time a form is deleted
        removeAnimationDuration: 0 // Duration of animating the removal of a form
    };
})(jQuery)
